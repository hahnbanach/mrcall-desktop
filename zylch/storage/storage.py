...
from .models import (
    Email, CalendarEvent, Blob, BlobSentence, OAuthToken,
    Draft, TaskItem, BackgroundJob,
    AgentPrompt, UserNotification,
    MrcallConversation, Contact, SyncState,
)
...
class Storage:
    ...
    def reap_zombie_jobs(self) -> int:
        ...
        import os as _os
        with get_session() as session:
            running = session.query(BackgroundJob)\
