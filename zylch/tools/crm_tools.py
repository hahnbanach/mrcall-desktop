...
class SearchPipedrivePersonTool(Tool):
    ...
    def __init__(self, pipedrive_client):
        super().__init__(
            ...
            description=(
                "Search for a person in Pipedrive CRM"
                " by email address"
            ),
        )
            ...
            return ToolResult(
                ...
                data={
                    ...
                    "person": {
                        ...
                        "emails": emails,
                        "phones": phones,
                        "open_deals_count": person.get(
                            "open_deals_count", 0
                        ),
                        "closed_deals_count": person.get(
...
class GetPipedrivePersonDealsTool(Tool):
    ...
    def __init__(self, pipedrive_client):
        super().__init__(
            ...
            description=(
                "Get deals for a person in Pipedrive with"
                " optional pipeline/stage filters"
            ),
        )
        self.pipedrive = pipedrive_client
        ...
        try:
            ...
            if not deals:
                return ToolResult(
                    ...
                    data={"deals": [], "count": 0},
                    message=(
                        "No deals found with specified filters"
                    ),
                )
            ...
            "input_schema": {
                ...
                "properties": {
                    "request": {
                        "type": "string",
                        "description": (
                            "What to write (e.g., 'reply to Mario"
                            " about the proposal')"
                        ),
                    },
                    "recipient_email": {
                    ...
                    "task_num": {
                        "type": "integer",
                        "description": (
                            "Task number from /tasks output"
                            " (optional - includes task context)"
                        ),
                    },
                },
                "required": ["request"],
