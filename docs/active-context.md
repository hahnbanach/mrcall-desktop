...
| Multi-profile routing plan (`mrcalld` + per-uid Unix sockets + `sudo` updater) | [`execution-plans/multi-profile-routing.md`](execution-plans/multi-profile-routing.md) |
