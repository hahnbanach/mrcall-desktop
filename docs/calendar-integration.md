...
**Complete guide to MrPark's calendar management and Google Meet video conference features**

---

## Overview

MrPark integrates with Google Calendar to:
...
**User request:**
> "Rispondi gentilmente a Natascia che va benissimo, crea un invito per tutti i partecipanti dell'ultima mail all'orario richiesto, con link meet"

**What MrPark does:**

1. **Searches the email** from Natascia
...
3. **Identifies all participants**:
   - Sender: natascia.conforti@connecto.energy
...
→ MrPark creates event with Meet link
...
When MrPark creates events from emails, it follows these rules:
...
- MrPark defaults to UTC, converts to local
