...
7. **SMS: When the user asks to send an SMS or text message → ALWAYS call `send_sms` tool. NEVER claim you sent an SMS without actually calling the tool.**
...
**SMS (via MrCall credits, needs sign-in):**
