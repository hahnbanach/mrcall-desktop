...
Uso:
  ZYLCH_PROFILE=user@example.com venv/bin/python scripts/diag_custom124.py
    ...
    with get_session() as s:
        ...
        unproc_c124 = (
            ...
            .filter(
                ...
                Email.from_email == "customer@example.com",
            )
            .count()
        )
        proc_c124 = (
        ...
        rows = (
            s.query(Email)
            .filter(Email.from_email == "customer@example.com")
