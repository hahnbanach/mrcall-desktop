...
PG_URL = "postgresql://postgres:REDACTED-PG-PASSWORD@REDACTED-HOST:0000/railway"
...
def main():
    ...
    sl_cur = sl_conn.cursor()
    sl_cur.execute(
        "UPDATE blobs SET namespace = REPLACE(namespace, 'REDACTED-FIREBASE-UID', 'support@mrcall.ai')"
