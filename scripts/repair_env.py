...
Uso:
  ZYLCH_PROFILE=user@example.com venv/bin/python scripts/repair_env.py          # dry-run
  ZYLCH_PROFILE=user@example.com venv/bin/python scripts/repair_env.py --apply
"""
import argparse
import os
import shutil
