...
class TestMrCallOAuthEndpoints:
    ...
    def test_mrcall_authorize_returns_auth_url(self, mock_settings, mock_storage, mock_get_user, client, mock_firebase_user):
    ...
    @patch('zylch.api.routes.auth.get_current_user')
    @patch('zylch.api.routes.auth.settings')
    def test_mrcall_authorize_missing_credentials(self, mock_settings, mock_get_user, client, mock_firebase_user):
    ...
    def test_mrcall_callback_success(self, mock_fetch_business, mock_settings, mock_storage, client):
    ...
    def test_mrcall_status_connected(self, mock_get_creds, mock_get_user, client, mock_firebase_user):
    ...
    @patch('zylch.api.routes.auth.get_current_user')
    @patch('zylch.api.token_storage.get_mrcall_credentials')
    def test_mrcall_status_not_connected(self, mock_get_creds, mock_get_user, client, mock_firebase_user):
    ...
    @patch('zylch.api.routes.auth.get_current_user')
    @patch('zylch.api.token_storage.get_mrcall_credentials')
    def test_mrcall_status_expired_token(self, mock_get_creds, mock_get_user, client, mock_firebase_user):
    ...
    def test_mrcall_revoke_success(self, mock_delete, mock_get_creds, mock_get_user, client, mock_firebase_user):
...
class TestMrCallTokenStorage:
    ...
    def test_save_mrcall_credentials(self, mock_supabase):
        ...
        result = save_mrcall_credentials(
            owner_id='test_user_123',
    ...
    def test_delete_mrcall_credentials(self, mock_supabase):
        ...
        mock_supabase.delete_provider_credentials.assert_called_once_with(
            'test_user_123',
            'mrcall'
        )
