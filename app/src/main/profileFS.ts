...
export const KNOWN_KEYS: ReadonlySet<string> = new Set([
  'ANTHROPIC_API_KEY',
  'LLM_PROVIDER', 'LLM_MODEL_PRESET', 'LLM_DAILY_BUDGET_USD', 'OPENROUTER_API_KEY',
  'OPENROUTER_MODEL', 'ANTHROPIC_MODEL', 'MRCALL_CREDITS_MODEL', 'PREPARATION_BATCH_SIZE',
  'MODEL_MEMORY_EXTRACT', 'MODEL_MEMORY_MERGE', 'MODEL_TASK_DETECTION', 'MODEL_REANALYZE', 'MODEL_DEDUP',
  'AUTO_UPDATE_ENABLED',
