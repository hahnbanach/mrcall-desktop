# Zylch AI - Implementation Specification

## Project Overview

Evolve the existing MCP Gateway codebase into Zylch AI, a single-agent Multi-Channel Sales Intelligence System that helps sales professionals manage email communications and follow-up actions. The system prioritizes contacts based on relationships, enriches contact data from multiple sources, drafts responses, and manages task scheduling via Google Calendar.
...
Zylch AI prioritizes PRECISION and SPEED over cost optimization:
...
Zylch AI - Email Intelligence Assistant
...
class Zylch AIAgent:
    ...
    def _get_system_prompt(self) -> str:
        ...
        return """You are Zylch AI, an Email Intelligence Assistant helping a sales professional manage communications and follow-ups.
...
name = "zylch"
version = "0.1.0"
description = "Zylch AI - Multi-Channel Sales Intelligence System for Sales Professionals"
dependencies = [
    "anthropic>=0.39.0",
...
5. **Rename**: Project to Zylch AI

The MCP Gateway codebase provides a solid foundation. The migration focuses on simplifying the architecture while adding email-specific intelligence under the Zylch AI brand.
...
**Why**: Currently, Sonnet analyzes tasks from scratch each time. With reasoning history, Zylch AI "remembers" past decisions and actions.
...
4. **Learning Over Time**: Zylch AI gets better at suggestions based on your history
...
**Zylch AI-Specific Evaluation** (if/when needed):
...
**Recommendation**:
- **Phase 10** (Reasoning Bank): DIY SQLite - perfect for Zylch AI
...
- Zylch AI's single-agent architecture is optimal
