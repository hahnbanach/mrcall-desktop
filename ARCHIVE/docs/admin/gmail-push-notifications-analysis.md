...
### Current Zylch AI Architecture

#### Existing Components
- **`/Users/mal/starchat/zylch/zylch/webhook/`**: Empty directory exists, ready for webhook implementation
- **`GmailClient`** (`/Users/mal/starchat/zylch/zylch/tools/gmail.py`): Currently implements:
...
- **`EmailSyncManager`** (`/Users/mal/starchat/zylch/zylch/tools/email_sync.py`):
...
2. **Webhook Endpoint** (`zylch/webhook/gmail_webhook.py`):
...
3. **Watch Manager** (`zylch/tools/gmail_watch.py`):
...
1. Create Flask/FastAPI app in `zylch/webhook/`
